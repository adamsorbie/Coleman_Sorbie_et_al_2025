...
luminal_splsda <- tune.run.block.splsda(keepXlist=X.list,
...
luminal_perf <- perf(luminal_splsda, folds=args$folds, nrepeat=10)

save(luminal_splsda, luminal_perf, file="../data/integration/luminal_integration_phenotype.RData")
...
### All variables not generated in this file are coming from DIABLO.R ###
mucosal_splsda <- tune.run.block.splsda(keepXlist=X.list,
...
mucosal_perf <- perf(mucosal_splsda, folds=args$folds, nrepeat=10)

save(mucosal_splsda, mucosal_perf, file="../data/integration/mucosal_integration_phenotype.RData")
