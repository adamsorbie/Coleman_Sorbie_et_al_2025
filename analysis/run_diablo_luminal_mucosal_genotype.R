...
genotype_splsda <- tune.run.block.splsda(keepXlist=X.list,
                                X=combined_data,
                                Y=luminal_phenotype,
                                design=design,
                                ncomp=args$ncomp,
...
genotype_perf <- perf(genotype_splsda, folds=args$folds, nrepeat=10)

save(genotype_splsda, genotype_perf, file="../data/integration/luminal_mucosal_integration_Genotype.RData")
